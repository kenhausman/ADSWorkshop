...
*Validation step*: When you build the solution, the only errors you receive are related to `ImageProcessor` in `Program.cs`. You also do not need to worry about yellow warning messages.  

NOTE: The program will <u>not</u> successfully build
